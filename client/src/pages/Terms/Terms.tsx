  ...
  return (
    <div className="page">
      ...
      <div className="text-content">
        ...
        <p>
          This website, mobile application or other digital or online application or service is operated by Elect Common Sense (“ECS“we,” “us” or “our”). These Terms of Service apply solely to your access to, and use of, the ElectCommonSense.com operated by us and other of our websites, mobile applications, or digital or online applications or services which link to these Terms of Service (collectively, the “Sites”). These Terms of Service do not alter in any way the terms or conditions of any other agreement you may have with us.
        </p>
        ...
        <ol>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                User Content that, in the sole judgment of ECS, is objectionable or which restricts or inhibits any other person from using or enjoying the Interactive Areas or the Sites, or which may ECS or its users to any harm or liability of any type.
              </li>
            </ul>
          ...
          <li>
            <span className="bold">REGISTRATION DATA; ACCOUNT SECURITY</span>. In consideration of your use of the Sites, you agree to (a) provide accurate, current and complete information about you as may be prompted by any registration forms on the Sites (“Registration Data”); (b) maintain the security of your password and identification; (c) maintain and promptly update the Registration Data, and any other information you provide to us, to keep it accurate, current and complete; and (d) accept all risks of unauthorized access to the Registration Data and any other information you provide to us.
          </li>

          <li>
            <span className="bold">INDEMNIFICATION</span>. You agree to defend, indemnify and hold harmless ECS, its affiliated organizations, its independent contractors, service providers and consultants, and their respective directors, employees and agents, from and against any claims, damages, costs, liabilities and expenses (including, but not limited to, reasonable attorneys’ fees) arising out of or related to any User Content you post, store or otherwise transmit on or through the Sites, your use of the Interactive Areas, or any act or omission relating to the Sites or the User Content, including without limitation any actual or threatened suit, demand or claim made against ECS and/or its independent contractors, service providers, employees, directors or consultants, arising out of or relating to the User Content, your conduct, your violation of these Terms of Service or your violation of the rights of any third party.
          </li>

          <li>
            <span className="bold">DISCLAIMERS</span>. EXCEPT AS EXPRESSLY PROVIDED TO THE CONTRARY IN A WRITING BY US, THE SITES, THE SITE MATERIALS CONTAINED THEREIN AND THE SERVICES PROVIDED ON OR IN CONNECTION THEREWITH (THE “SERVICES”) ARE PROVIDED ON AN “AS IS” BASIS WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. ECS DISCLAIMS ALL OTHER WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, WITHOUT LIMITATION, IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE AND NON-INFRINGEMENT AND AS TO ACCURACY OR RELIABILITY OF THE INFORMATION, CONTENT, FORMS OR OTHER SITE MATERIALS ACCESSED THROUGH THE SITE. ECS DOES NOT REPRESENT OR WARRANT THAT THE SITES, THE SITE MATERIALS OR THE SERVICES ARE ACCURATE, COMPLETE, RELIABLE, CURRENT OR ERROR-FREE. USE OF THE SITES IS AT YOUR SOLE RISK.

            <p>
              ECS IS NOT RESPONSIBLE FOR TYPOGRAPHICAL ERRORS OR OMISSIONS, INCLUDING THOSE RELATING TO PRICING, TEXT OR PHOTOGRAPHY. WHILE ECS ATTEMPTS TO MAKE YOUR ACCESS AND USE OF THE SITES AND SERVICES SAFE, ECS CANNOT AND DOES NOT REPRESENT OR WARRANT THAT THE SITES, THE SITE MATERIALS OR THE SERVER(S) ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS; THEREFORE, YOU SHOULD USE INDUSTRY-RECOGNIZED SOFTWARE TO DETECT AND DISINFECT VIRUSES FROM ANY DOWNLOAD.
            </p>

            <p>
              ECS DOES NOT REPRESENT OR ENDORSE THE ACCURACY OR RELIABILITY OF ANY ADVICE, OPINION, STATEMENT, OR OTHER INFORMATION DISPLAYED, UPLOADED, OR DISTRIBUTED THROUGH THE SITE BY ANY USER, INFORMATION PROVIDER OR ANY OTHER PERSON OR ENTITY. YOU ACKNOWLEDGE THAT ANY RELIANCE UPON ANY SUCH OPINION, ADVICE, STATEMENT, MEMORANDUM, OR INFORMATION SHALL BE AT YOUR SOLE RISK.
            </p>
          </li>

          <li>
            <span className="bold">LIMITATION OF LIABILITY</span>. IN NO EVENT SHALL ECS OR OUR EMPLOYEES, AGENTS OR VOLUNTEERS BE LIABLE FOR ANY DIRECT, SPECIAL, INDIRECT OR CONSEQUENTIAL DAMAGES, OR ANY OTHER DAMAGES OF ANY KIND, INCLUDING BUT NOT LIMITED TO LOSS OF USE, LOSS OF PROFITS OR LOSS OF DATA, WHETHER IN AN ACTION IN CONTRACT, TORT (INCLUDING BUT NOT LIMITED TO NEGLIGENCE) OR OTHERWISE, ARISING OUT OF OR IN ANY WAY CONNECTED WITH THE USE OF OR INABILITY TO USE THE SITES, THE SERVICES, THE CONTENT OR THE SITE MATERIALS CONTAINED IN OR ACCESSED THROUGH THE SITE, INCLUDING WITHOUT LIMITATION ANY DAMAGES CAUSED BY OR RESULTING FROM RELIANCE BY USER ON ANY INFORMATION OBTAINED FROM ECS, OR THAT RESULT FROM MISTAKES, OMISSIONS, INTERRUPTIONS, DELETION OF FILES OR EMAIL, ERRORS, DEFECTS, VIRUSES, DELAYS IN OPERATION OR TRANSMISSION OR ANY FAILURE OF PERFORMANCE, WHETHER OR NOT RESULTING FROM ACTS OF GOD, COMMUNICATIONS FAILURE, THEFT, DESTRUCTION OR UNAUTHORIZED ACCESS TO ECS’S RECORDS, PROGRAMS OR SERVICES. IN NO EVENT SHALL THE AGGREGATE LIABILITY OF ECS WHETHER IN CONTRACT, WARRANTY, TORT (INCLUDING NEGLIGENCE, WHETHER ACTIVE, PASSIVE OR IMPUTED), PRODUCT LIABILITY, STRICT LIABILITY OR OTHER THEORY, ARISING OUT OF OR RELATING TO THE USE OF OR INABILITY TO USE THE SITES OR THE SITE MATERIALS EXCEED ANY COMPENSATION YOU PAY, IF ANY, TO ECS FOR ACCESS TO OR USE OF THE SITES.
          ...
          <li>
            <span className="bold">AGREEMENT TO ARBITRATE DISPUTES</span>. Any claim, dispute or controversy of any kind, regardless of the type of claim or legal theory or remedy (“Claim”) by either you or ECS against the other arising from, relating to or in any way concerning the Terms of Service, Privacy Policy, or anything you receive from us (or from any advertising) must, at the demand of either party, be submitted to and determined by binding and confidential arbitration in Whippany before a single arbitrator. To the extent issues of state law are implicated, the laws of the state of New Jersey shall apply without reference to such state’s choice of law provisions that could require the application of another jurisdiction’s substantive laws. The arbitration will be administered by JAMS pursuant to its Comprehensive Arbitration Rules and Procedures in effect at the time of the arbitration and in accordance with the Expedited Procedures in those Rules. This agreement to arbitrate also includes: (i) Claims relating to the enforceability or interpretation of any of these arbitration provisions; (ii) Claims that relate directly to ECS and/or its affiliates, successors, assignees, employees, agents, or independent contractors; and (iv) Claims asserted as part of a class action, private attorney general or other representative action, it being expressly understood and agreed to by you and ECS that the arbitration of such claims must proceed on an individual (non-class and non-representative) basis and the arbitrator may award relief only on an individual (non-class and non-representative) basis. The parties shall maintain the confidential nature of the arbitration proceedings and award, including the hearing, except as may be necessary in connection with a court application for a preliminary remedy, a judicial challenge to an award or enforcement of the award, or unless otherwise required by law or judicial decision. Judgment upon the award rendered by an arbitrator hereunder may be entered in any court having jurisdiction.

            <p>
              YOU AND ECS HEREBY KNOWINGLY AND VOLUNTARILY WAIVE ANY RIGHT YOU HAVE TO A JURY TRIAL, OR AN APPEAL TO A STATE OR FEDERAL COURT OF APPEAL, WITH REGARD TO ANY DISPUTE ARISING UNDER, RELATING TO, OR IN CONNECTION WITH THE TERMS OF SERVICE, PRIVACY POLICY, OR ANYTHING YOU RECEIVE FROM US (OR FROM ANY ADVERTISING). ALL SUCH DISPUTES SHALL BE RESOLVED THROUGH BINDING ARBITRATION AND NO CLASS ACTION, CONSOLIDATED ACTION, PRIVATE ATTORNEY GENERAL OR OTHER REPRESENTATIVE CLAIMS MAY BE PURSUED IN ARBITRATION. BY ACCEPTING THIS ARBITRATION AGREEMENT, YOU AGREE TO WAIVE THE RIGHT TO INITIATE OR PARTICIPATE IN A CLASS ACTION, REPRESENTATIVE ACTION, PRIVATE ATTORNEY GENERAL ACTION OR CONSOLIDATED ARBITRATION IN ANY MATTER ENCOMPASSED BY THIS ARBITRATION PROVISION.
            </p>
          </li>

          <li>
            <span className="bold">TERMINATION</span>. Notwithstanding any of these Terms of Service, at all times we reserve the right, without notice and in our sole discretion, to terminate your license to use the Sites, and to block or prevent future your access to and use of the Sites.
          </li>
